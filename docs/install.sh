...
Files:
» microspec       - Run shell test files (with colorful output)
» microtap        - Run shell test files (with TAP output)
» example.spec.sh - Example test file.                       
                      Run it with:    microspec example.spec.sh
                      or run it with: microtap  example.spec.sh

For usage instructions, visit https://micro.specs.sh
"
########################
