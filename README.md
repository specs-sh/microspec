...
Download the [latest version](https://github.com/specs-sh/microspec/archive/v1.9.0.tar.gz) by clicking one of the download links above or:
...
```sh
#! /usr/bin/env bash
MICROSPEC_VERSION=1.9.0; [ "$1" = --version ] && { echo "microspec version $MICROSPEC_VERSION"; exit 0; }
